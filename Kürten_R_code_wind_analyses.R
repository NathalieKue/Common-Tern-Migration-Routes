...
comics <- comics[which(comics$dist_next > 100),] #removes "stopover behaviour"
...
# OK let's be real, this bit is super confusing.
...
for(i in 1:n){
  ...
  # So essentially all this does is it replicate the departure date for each bird by the number of fixes that are in the track in question.
  ...
  # caclulate a grand mean from all the individuals
